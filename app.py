...
if page_selection == "➕ Build New Quotation Module":
    ...
    st.caption(f"All base unit cost prices inside the grid should be entered in **USD**. The grid below dynamically displays values converted to **{currency_selection}** based on your sidebar configurations.")
    
    # Calculate conversion factor ahead of user interface engine to force live calculation redraws
