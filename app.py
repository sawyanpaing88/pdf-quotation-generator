...
if page_selection == "🏠 Dashboard Console":
    ...
    if not df_quotes.empty:
        # --- FIX SECURED HERE: PREVIOUSLY STRAY OPEN PARENTHESIS CAUSING FAILURE ---
...
# ==========================================
    ...
    st.caption("Wrap configuration is forced. Use dot-notation indices (e.g. 1.1, 1.2) to structure main items vs architectural sub-components.")
    ...
    edited_items_df = st.data_editor(
        ...
        column_config={
            ...
            "Unit Price": st.column_config.NumberColumn("Unit Cost Price", format="$%.2f"),
            "Margin %": st.column_config.NumberColumn("Margin per Line (%)"),
            "Final Price": st.column_config.NumberColumn("Final Unit Price", format="$%.2f", disabled=True)
        }
    )
    ...
    if action_c2.button("🖨️ Compile Official Corporate PDF Engine Asset"):
        ...
        for idx, r in edited_items_df.iterrows():
            ...
            <tr>
                ...
                <td style="white-space: normal; word-break: break-all;">{r['Part Number/Model']}</td>
        ...
        <head>
            ...
            <style>
                ...
                .address-text {{ font-size: 8pt; color: #4b5563; text-align: right; line-height: 1.4; }}
